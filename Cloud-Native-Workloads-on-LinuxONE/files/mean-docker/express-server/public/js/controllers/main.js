angular.module('todoController', [])
	...
	.controller('mainController', ['$scope', '$http', 'Todos', function ($scope, $http, Todos) {
        ...
        $scope.deposit=function(){
			$scope.loading = true;
			Todos.deposit_money($scope.formData.savings)
			.success(function(data){
				mySavings=data
				if(mySavings<=0){
					alert("The deposit money should be greater than 0.");
					location.href = '../../../business/service.html'
				}
				else{
					location.href = '../../../business/service.html'
					$scope.loading = false;
					$scope.formData = {savings:$scope.formData.savings};
				}
			})
		};
